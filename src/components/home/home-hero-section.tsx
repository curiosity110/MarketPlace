...
export function HomeHeroSection({
  ...
  return (
    <section className="hero-surface max-w-full overflow-hidden rounded-3xl border border-border/70 px-5 py-10 sm:px-8 sm:py-12 md:px-12 md:py-16">
      <div className="grid max-w-full min-w-0 gap-10 lg:grid-cols-[minmax(0,1.2fr)_minmax(0,0.8fr)] lg:items-center">
        <div className="min-w-0 space-y-6">
          ...
          <h1 className="max-w-3xl break-words text-4xl font-black tracking-tight [overflow-wrap:anywhere] sm:text-5xl lg:text-6xl">
            {text.heroTitleA}
            <span className="block bg-gradient-to-r from-orange-500 to-blue-600 bg-clip-text text-transparent">
              {text.heroTitleB}
            </span>
          </h1>
          <p className="max-w-2xl break-words text-base text-muted-foreground [overflow-wrap:anywhere] sm:text-lg">
            {text.heroDesc}
          </p>
